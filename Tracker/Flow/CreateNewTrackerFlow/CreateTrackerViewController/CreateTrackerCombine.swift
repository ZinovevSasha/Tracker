...
//    
//    func bind() {
//        viewModel?.$canCreateTracker
//            .receive(on: DispatchQueue.main)
//            .sink(receiveValue: { [weak self] canCreate in
//                if canCreate {
...
//        } else {
//            let selectedWeekDays = viewModel?.trackerWeekDay ?? []
...
//            // save data
//            self.viewModel?.trackerWeekDay = weekDays
//            
...
//        if text.isEmpty {
//            self.viewModel?.trackerName = nil
//        } else {
//            self.viewModel?.trackerName = text
//        }
//        
//        let maxLength = 38
